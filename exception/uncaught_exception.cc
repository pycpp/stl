...
#       define PYCPP_HAVE_CXA_GET_GLOBALS
...
#       define PYCPP_HAVE_UNCAUGHT_EXCEPTIONS
#   elif HAVE_MSVC_8 >= 8
#       define PYCPP_HAVE_GETPTD
...
#elif defined(PYCPP_HAVE_GETPTD)
